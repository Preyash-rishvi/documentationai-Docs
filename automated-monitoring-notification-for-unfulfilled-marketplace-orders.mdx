...
<ExpandableGroup>
  ...
  <Expandable title="Smart Filtering" default-open="false">
    Allows you to monitor only relevant orders by selecting specific sources (such as Amazon or eBay) and excluding unnecessary subsources.
  </Expandable>

  <Expandable title="Automated Email Notifications" default-open="false">
    Sends alerts directly to your team with key order details, helping them quickly understand and act on delays.
  </Expandable>

  <Expandable title="CSV Reporting for Analysis" default-open="false">
    Provides a downloadable CSV file with complete order details, making it easier to track, analyse, and share information internally.
  </Expandable>

  <Expandable title="Duplicate Alert Prevention" default-open="false">
  ...
  <Expandable title="Scalable for Growing Operations" default-open="false">
